...
#     # Check conditions
#     exam_id=frappe.get_all("Students Master Data",filters={"imported_batch_id":None})
...
#         # Update the imported_batch_id field in Student Master Data
#         frappe.log_error("After condition I am getting errror")
#         frappe.db.set_value(
#             'Students Master Data',
#             filters={'imported_batch_id': ('in',[None])},
...
def update_imported_batch_id(exam_id):
    # Find all records in Student Master Data where imported_batch_id is empty or null
    ...
    if not student_records:
        return {'status': 'error', 'message': 'No Student Master Data records found without imported_batch_id.'}
    
    # Update each Student Master Data record with the provided exam_id
    for record in student_records:
        frappe.db.set_value('Students Master Data', record['name'], 'imported_batch_id', exam_id)
